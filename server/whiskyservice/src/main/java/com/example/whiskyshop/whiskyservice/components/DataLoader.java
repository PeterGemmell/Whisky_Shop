...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args){
        ...
        Whisky whisky5 = new Whisky("Blair Athol", "12 Year Old Flora and Fauna", "Highland", "43%", "70cl", "https://cdn.shopify.com/s/files/1/0248/6121/2758/products/blair-athol-12yo-faf_1024x1024@2x.jpg", 12.99, 60.49, "A full, rich and spicy 12 year old single malt whisky. Slightly dry on the finish.", 0, false);
        whiskyRepository.save(whisky5);

        Whisky whisky6 = new Whisky("Lagavulin", "16 Year Old", "Islands", "43%", "70cl", "https://cdn.shopify.com/s/files/1/0248/6121/2758/products/5000281005409_T1_1024x1024@2x.jpg", 23.45, 60.49, "Aged in oak casks for at least 16 years, this much sought after Single Malt has the massive peat smoke flavour thats typical of southern Islay.", 0, false);
        whiskyRepository.save(whisky6);

        Whisky whisky7 = new Whisky("Coal Ila", "12 Year Old", "Islands", "43%", "70cl", "https://cdn.shopify.com/s/files/1/0248/6121/2758/products/caol-lia-12yo_1024x1024@2x.jpg", 12.67, 45.49, "Fresh, sweetly fruity and smooth bodied, Caol Ila 12 year old is the colour of pale straw.", 0, false);
        whiskyRepository.save(whisky7);

        Whisky whisky8 = new Whisky("Talisker", "Skye", "Islands", "45.8%", "70cl", "https://cdn.shopify.com/s/files/1/0248/6121/2758/products/5000281038094_T1_1024x1024@2x.jpg", 18.52, 40.49, "Talisker Skye is the brands ode to these appealing contrasts, with a smoky sweetness, maritime notes and a spicy edge.", 0, false);
        whiskyRepository.save(whisky8);

        Whisky whisky9 = new Whisky("Lagavulin", "12 Year Old Special Release 2019", "Islands", "56.5%", "70cl", "https://cdn.shopify.com/s/files/1/0248/6121/2758/products/lagavulin-12-01_1024x1024@2x.jpg", 19.50, 110.49, "A classic stripped down acoustic Lagavulin, pure in style and from spirit specially selected for its high peating levels.", 0, false);
        whiskyRepository.save(whisky9);

        Whisky whisky10 = new Whisky("Port Ellen", "40 Year Old 9 Rogue Casks", "Islands", "50.9%", "70cl", "https://cdn.shopify.com/s/files/1/0248/6121/2758/products/portellen40-06_1024x1024@2x.jpg", 578.92, 6.920, "There are only 1380 bottles available of the 9 Rogue Casks release. Authentic in colour and cask strength", 0, false);
        whiskyRepository.save(whisky10);

        Whisky whisky11 = new Whisky("Cardhu", "12 Year Old", "Speyside", "40%", "70cl", "https://cdn.shopify.com/s/files/1/0248/6121/2758/products/cardhu_12y_1024x1024@2x.jpg", 15.99, 44.49, "Enticing and silky smooth, this is the quintessential Cardhu. Glowing with notes of golden honey and delicate, fruity character.", 0, false);
        whiskyRepository.save(whisky11);

        Whisky whisky12 = new Whisky("Cragganmore", "12 Year Old", "Speyside", "40%", "70cl", "https://cdn.shopify.com/s/files/1/0248/6121/2758/products/5000281005430_T1_1024x1024@2x.jpg", 17.26, 41.49, "A complex Speyside single malt whiskey praised for its depth and complexity.", 0, false);
        whiskyRepository.save(whisky12);

        Whisky whisky13 = new Whisky("Glen Elgin", "12 Year Old", "Speyside", "43%", "70cl", "https://cdn.shopify.com/s/files/1/0248/6121/2758/products/5000281016467_T1_1024x1024@2x.jpg", 18.99, 41.49, "Honey sweet character, often called fruitcake in a bottle.", 0, false);
